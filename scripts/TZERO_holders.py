...
def get_TZERO_holders(page):
    url = "https://alephzero-testnet.api.subscan.io/api/scan/token/holders"
...
def save_csv(data):
    csv_file = "TZERO_holders.csv"  # Added .csv extension
...
def main():
    ...
    while True:  # Loop until there are no more holders to fetch
        ...
        holders_data = get_TZERO_holders(page_number)
